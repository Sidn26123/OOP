...
public class Calculator extends javax.swing.JFrame {
    ...
    private void addActionListeners(Thu thu) {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(buttonText.matches("[0-9]")){
                    ...
                    try {
                        ...
                        thu.update_valueCalculator(result_return);
                    } catch (Exception exe) {
                        JOptionPane.showMessageDialog(Calculator.this, "Không đúng định dạng số","Thông báo",JOptionPane.OK_OPTION);
                    }
                }
                else{
                    // operator
