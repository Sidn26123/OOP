...
public class Calculator_Chi extends javax.swing.JFrame {
    ...
    public Calculator_Chi(Chi chi) {
        initComponents();
        calculatorService = new CalculatorService();
        this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        addActionListeners(chi);
    ...
    private void addActionListeners(Chi chi) {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(buttonText.matches("[0-9]")){
                    ...
                    switch(calculatorService.getMathSymbol()){
                        case '+' -> result = calculatorService.add();
                        case '-' -> result = calculatorService.subtract();
                        case '/' -> result = calculatorService.divide();
                        case 'X' -> result = calculatorService.multiply();
                    }
                    ...
                    try {
                        ...
                        chi.update_valueCalculator(result_return);
                    } catch (NumberFormatException exe) {
                        JOptionPane.showMessageDialog(Calculator_Chi.this, "Không đúng định dạng số","Thông báo",JOptionPane.OK_OPTION);
                    }
                }
                else{
                    // operator
