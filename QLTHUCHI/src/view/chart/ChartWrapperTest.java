 ...
 * @author sidac
 */
public class ChartWrapperTest extends javax.swing.JFrame {

    /**
     * Creates new form ChartWrapperTest
     */
    public ChartWrapperTest() {
        initComponents();
    }
    ...
    private void updateDataBtnActionPerformed(java.awt.event.ActionEvent evt) {                                              
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChartWrapperTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChartWrapperTest().setVisible(true);
            }
        });
    }
