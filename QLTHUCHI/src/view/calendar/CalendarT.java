...
public class CalendarT extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        calendarWrapper = new render.PanelBorder();
...
//        Object[][] data = logsDB.getGeneralInfoOfDates(month, year);
         Object[][] data = {
             {81, 84, "1/01/2023"},
             {51, 88, "2/01/2023"},
             {14, 66, "3/01/2023"},
...
//                    render.renderTransactionTableWithFrame(data);
    ...
    private void button_preActionPerformed(java.awt.event.ActionEvent evt) {                                           
        ...
        Object[][] data = new LogsDB().getGeneralInfoOfDates((this.month),(this.year));
        Component[] components = calendarShowPanel.getComponents();
        for (Component component : components) {
            calendarShowPanel.remove(component);
        }
        calendarWrapper.validate();
...
//        EnchanceTable e = new EnchanceTable();
        render.enhanceTable render = new render.enhanceTable();
...
//        eTable = e.enchanedTable(datas);
        ...
        eTable.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(keyStroke, "disposeFrame");
        eTable.getActionMap().put("disposeFrame", action);
    ...
    private static void disposeFrame(JFrame testFrame) {
        testFrame.dispose();
    }
    ...
    private PanelBorder calendarWrapper;
