...
public class DanhMucChi {
    ...
    public static void populateDanhmucComboBox(JComboBox<String> Danhmuc,int ID_User) {
        ...
        try {
            ...
            String sql = "SELECT Name_Type FROM Type WHERE ID_User = ? AND Receipts_Or_expenses = 0 OR ID_User = -2";
    ...
    private static boolean isCategoryAlreadyExists(String newCategory, JComboBox<String> Danhmuc,int ID_User) {
        ...
        try {
            ...
            String sql = "SELECT COUNT(*) FROM Type WHERE UPPER(Name_Type) = UPPER(?) and (ID_User = ? AND Receipts_Or_expenses = 0 OR ID_User = -2)";
            preparedStatement = connection.prepareStatement(sql);
